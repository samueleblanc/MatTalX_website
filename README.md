...
`images/og-card.png` is generated by `tools/build-card.py`. It is a poster rather than a
screenshot, because a card is drawn at 1200x630 and shown at about 500 wide, where the
text in a screenshot cannot be read.
